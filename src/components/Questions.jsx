            ...
            <div className="questions-container">
                <div className="question-container">
                    ...
                    <p className="answer hidden-answer">
                        ...
                        for one low monthly price. There's always something new to discover and 
                ...
                <div className="question-container">
                    ...
                    <p className="answer hidden-answer">
                        ...
                        all for one fixed monthly fee. Plans range from USD3.99 to USD9.99 a month. No extra costs, no contracts.
                    </p>
                </div>
                <div className="question-container">
                    <div className="question-title" onClick={(e) => {handleAnswer(e)}}>
